    ...
    <>
      ...
      <section id="projects" className="py-32 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <motion.h2
            className="text-4xl md:text-6xl font-black tracking-tight mb-16 relative group cursor-pointer"
          ...
          >
            PROJECT WORK
            <motion.span
              className="absolute bottom-0 left-0 w-0 h-1 bg-black"
          ...
          <div className="space-y-12">
            {displayedProjects.map((project, index) => (
              <motion.div
                ...
                key={project.id}
                className="group border-b border-gray-300 pb-12 last:border-b-0 relative"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: false, amount: 0.2 }}
                transition={{
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-3">
                      <motion.h3
                        className="text-2xl md:text-4xl font-bold group-hover:text-gray-600 transition-colors cursor-pointer"
                        whileHover={{ x: 5 }}
                      ...
                      <span className="px-2 py-1 text-xs font-medium bg-white border border-gray-300 rounded">
                        {project.category}
                      </span>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tech.map((tech, techIndex) => (
                        <motion.span
                          key={techIndex}
                          className="px-3 py-1 text-sm font-medium bg-white border border-gray-300 hover:bg-black hover:text-white transition-colors cursor-pointer"
              ...
              <div id="container">
                <Link href="/projects">
                  <button className="learn-more">
                    ...
                    <span className="button-text !text-[#2563eb]">
                      Show More
                    </span>
                  </button>
                </Link>
              ...
              <div className="mx-auto px-8 py-20 md:py-16">
                ...
                >
                  <div className="relative rounded-lg overflow-hidden border border-gray-700">
                    <Image
                      src={selectedProject.screenshots[0] || "/placeholder.svg"}
